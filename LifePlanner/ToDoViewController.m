...
{
    if ([segue.sourceViewController isKindOfClass:[AddEntryTableViewController class]]) {
        AddEntryTableViewController *aevc = (AddEntryTableViewController *)segue.sourceViewController;
    }
    else {
