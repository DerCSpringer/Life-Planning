...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    if ([segue.destinationViewController isKindOfClass:[HabitCDTVC class]] ) {
        if (self.context) {
            ...
            //if I've updated the date for the alert then delete the old notification and put in a new one for teh time
            ...
            else if (self.completionType.selectedSegmentIndex == 0 && !habit.notification && [[[NSUserDefaults standardUserDefaults] valueForKey:HABIT_ALERTS] boolValue]) {
...
//Refactor this it's excessive to put this implementation in two classes
//It too long too
