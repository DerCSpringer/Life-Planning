...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    if (self.fieldsFromCell) {
        ...
        //I use an array of entity names as delcared above.  It checks to see if any of those any of those entity names are in the dictionary(fields contain the entity name along with its data).
